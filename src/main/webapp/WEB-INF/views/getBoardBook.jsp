    	...
    	<div class="banner-content banner-content-board banner-content-getBoardBook">
    		<div class="banner-content-board-insert">
        		...
        		<a href="getBoardList.do">글목록</a>
     			...
     			<div class="insert-board-book-form">
     				<form action=insertBoard.do method=post>
     					<div class="board-header">
	            <input type=text name=title placeholder="Title" class="title" disabled>
		          ...
		          <div class="board-center">
		            <div class="text-pos">
		              <textarea class="textarea" name="content" rows="10" cols="40" placeholder="content" disabled></textarea>
		            </div>
